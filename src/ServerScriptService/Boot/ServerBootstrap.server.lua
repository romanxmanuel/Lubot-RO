...
local loadedServices = {
    ...
    ImportedAssetService = require(Services.ImportedAssetService),
    MarketplaceVfxService = require(Services.MarketplaceVfxService),
...
local orderedServices = {
    ...
    loadedServices.ImportedAssetService,
    loadedServices.MarketplaceVfxService,
